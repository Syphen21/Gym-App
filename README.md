...
```bash
sudo git clone https://github.com/Syphen21/Gym-App.git
```

Windows:

```bash
git clone https://github.com/Syphen21/Gym-App.git
```

### Contact

If you want to contact with me you can reach me at [E-Mail](jeetariwa21@gmail.com).
